...
public class GalleryActivity {
    ...
    GalleryActivity(Context context) {
...
//    } //onCreate END
    ...
    void tedPermission() {
        ...
        TedPermission.with(context) //동작되었을떄 안내문구
                .setPermissionListener(permissionListener);
        //.setRationaleMessage(getResources().getString(R.string.permi))

        Toast.makeText(context, "카메라 성공", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PICK_FROM_GALLERY) {
            ...
            try {
                ...
                cursor = context.getContentResolver().query(photoUri, proj, null, null); //사진
                assert cursor != null;
